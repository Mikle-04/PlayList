...
class PlayListImgStorageViewHolder(view: View, val context: Context) : RecyclerView.ViewHolder(view) {
    ...
    private val imgCoverPlaylist: ImageView = view.findViewById(R.id.cover_playlist_in_playlist)
